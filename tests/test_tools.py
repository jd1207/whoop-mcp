...
async def test_create_activity():
    ...
    with patch("whoop_write_mcp.auth.get_whoop_client", return_value=mock_client):
        from whoop_write_mcp.tools import create_activity
...
async def test_get_recovery():
    ...
    with patch("whoop_write_mcp.auth.get_whoop_client", return_value=mock_client):
        from whoop_write_mcp.tools import get_recovery
...
async def test_update_weight():
    ...
    with patch("whoop_write_mcp.auth.get_whoop_client", return_value=mock_client):
        from whoop_write_mcp.tools import update_weight
...
async def test_list_activities():
    ...
    with patch("whoop_write_mcp.auth.get_whoop_client", return_value=mock_client):
        from whoop_write_mcp.tools import list_activities
